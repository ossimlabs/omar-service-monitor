  ...
  render() {
    return (
      <ErrorBoundary>
        ...
        <div>
          <p className="services-description">View realtime information on applications that have been installed in given O2 deployments
          <span className="legend right">Instances Legend&nbsp;
